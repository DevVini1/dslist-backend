package com.TechVini.dslist.entities;
...
@GeneratedValue(strategy = GenerationType.IDENTITY) //indica para o banco gerar um ID automaticamente
private Long id;
private String title;

@Column(name = "game_year") //modifica o nome year que é padrão no SQL para outro nome que não irá gerar conflito
private int year;
